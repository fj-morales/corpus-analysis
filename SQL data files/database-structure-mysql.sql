...
#Create index
ALTER TABLE SENTENCE ADD INDEX index_sentence_detail(sentence_detail);
ALTER TABLE SENTENCE ADD INDEX index_sentence_document_id(document_label,corpus_id);