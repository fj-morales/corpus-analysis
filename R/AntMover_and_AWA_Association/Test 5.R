...
mainCategory <- subset(resultTest,resultTest$AWA_LABEL=='Important')
mainCategory <- rbind(mainCategory,subset(resultTest,resultTest$AWA_LABEL=='Summary'))
mainCategory <- rbind(mainCategory,subset(resultTest,resultTest$AWA_LABEL=='Important&Summary'))
