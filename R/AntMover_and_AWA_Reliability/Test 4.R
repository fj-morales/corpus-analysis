...
queryStatement <- paste0("SELECT TOTAL.sentence_id,SENTENCE_ANNOTATION.annotation_id AS 'AntMover' ",
                         "FROM ",
                         "( ",
                         "SELECT sentence_id FROM SENTENCE_ANNOTATION ",
                         "WHERE tool_id=1 AND annotation_id=3 ",
                         "UNION ",
                         "SELECT sentence_id FROM SENTENCE_ANNOTATION ",
                         "WHERE tool_id=2 AND annotation_id IN (37) ",
                         ") TOTAL ",
                         "LEFT JOIN SENTENCE_ANNOTATION ON TOTAL.sentence_id = SENTENCE_ANNOTATION.sentence_id ",
                         "AND SENTENCE_ANNOTATION.tool_id=1 AND SENTENCE_ANNOTATION.annotation_id=3 ",
                         "ORDER BY TOTAL.sentence_id ASC")
...
queryStatement <- paste0("SELECT TOTAL.sentence_id,SENTENCE_ANNOTATION.annotation_id AS 'AWA' ",
                         "FROM ",
                         "( ",
                         "SELECT sentence_id FROM SENTENCE_ANNOTATION ",
                         "WHERE tool_id=1 AND annotation_id=3 ",
                         ...
                         ") TOTAL ",
                         "LEFT JOIN SENTENCE_ANNOTATION ON TOTAL.sentence_id = SENTENCE_ANNOTATION.sentence_id ",
                         "AND SENTENCE_ANNOTATION.tool_id=2 AND SENTENCE_ANNOTATION.annotation_id IN (37) ",
                         "ORDER BY TOTAL.sentence_id ASC")
